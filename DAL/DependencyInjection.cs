...
namespace DAL
{
    public static class DependencyInjection
    {
        ...
        public static IServiceCollection RegistDALTransient(this IServiceCollection services, IConfiguration configuration)
        {
            //Lazyloading have bad perfomance  
            //https://wildermuth.com/2018/07/28/Avoid-Lazy-Loading-in-ASP-NET
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseSqlServer(
                    configuration.GetConnectionString("DefaultConnection"),
                     b => b.MigrationsAssembly(typeof(ApplicationDbContext).Assembly.FullName)).UseLazyLoadingProxies(), contextLifetime: ServiceLifetime.Transient);
